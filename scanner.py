...
SCAN_MARKETS = [
    ...
    "MATICUSDT", "DOTUSDT", "LINKUSDT", "AVAXUSDT", "LTCUSDT", "ATOMUSDT", "ETCUSDT",
    "FILUSDT", "NEARUSDT", "APTUSDT", "ARBUSDT", "OPUSDT", "AAVEUSDT", "SANDUSDT",
    "MANAUSDT", "AXSUSDT", "EGLDUSDT", "GALAUSDT", "FTMUSDT", "THETAUSDT", "FLOWUSDT",
    "CHZUSDT", "CRVUSDT", "DYDXUSDT", "GMXUSDT", "INJUSDT", "KAVAUSDT", "LDOUSDT",
    "PEPEUSDT", "RNDRUSDT", "RUNEUSDT", "STXUSDT", "SUSHIUSDT", "TRXUSDT", "UNIUSDT",
    "XLMUSDT", "XTZUSDT", "ZECUSDT", "ZILUSDT", "1000SHIBUSDT", "ICPUSDT", "KSMUSDT",
    "ALGOUSDT",
]
